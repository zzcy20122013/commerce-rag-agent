...
- Create: `commerce-rag-agent/backend/app/main.py`
- Create: `commerce-rag-agent/backend/pyproject.toml`
- Create: `commerce-rag-agent/backend/.env.example`
- Test: `commerce-rag-agent/backend/app/tests/test_health.py`
...
- Create: `commerce-rag-agent/backend/app/models/db.py`
- Create: `commerce-rag-agent/backend/app/models/tables.py`
- Create: `commerce-rag-agent/backend/app/models/schemas.py`
- Create: `commerce-rag-agent/backend/app/scripts/seed_products.py`
- Test: `commerce-rag-agent/backend/app/tests/test_product_filter.py`
...
- Create: `commerce-rag-agent/backend/app/llm/openai_compatible_client.py`
- Create: `commerce-rag-agent/backend/app/llm/prompts.py`
- Create: `commerce-rag-agent/backend/app/llm/schemas.py`
- Test: `commerce-rag-agent/backend/app/tests/test_intent_router.py`
...
- Create: `commerce-rag-agent/backend/app/embeddings/bge_m3.py`
- Create: `commerce-rag-agent/backend/app/retrieval/text_index.py`
...
- Create: `commerce-rag-agent/backend/app/api/docs.py`
- Create: `commerce-rag-agent/backend/app/services/document_service.py`
- Create: `commerce-rag-agent/backend/app/retrieval/document_index.py`
- Create: `commerce-rag-agent/backend/app/scripts/ingest_docs.py`
- Test: `commerce-rag-agent/backend/app/tests/test_document_ingestion.py`
...
- Create: `commerce-rag-agent/backend/app/agents/state.py`
- Create: `commerce-rag-agent/backend/app/agents/graph.py`
- Create: `commerce-rag-agent/backend/app/agents/intent_router.py`
- Create: `commerce-rag-agent/backend/app/agents/shopping_guide.py`
- Create: `commerce-rag-agent/backend/app/agents/faq.py`
- Create: `commerce-rag-agent/backend/app/agents/chitchat.py`
...
- Create: `commerce-rag-agent/backend/app/api/chat.py`
- Modify: `commerce-rag-agent/backend/app/main.py`
- Test: `commerce-rag-agent/backend/app/tests/test_chat_stream.py`
...
- Create: `commerce-rag-agent/web-debug/package.json`
- Create: `commerce-rag-agent/web-debug/src/App.tsx`
- Create: `commerce-rag-agent/web-debug/src/api/chatStream.ts`
- Create: `commerce-rag-agent/web-debug/src/components/ProductCards.tsx`
